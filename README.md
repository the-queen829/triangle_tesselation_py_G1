# triangle_tesselation_py
Starter code for intro to Github lessons
...
Create changes to your code to add in your triangles. Test out the code, then copy your edits to the picture.py file that is in the repository.
